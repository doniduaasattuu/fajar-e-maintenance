<x-app-layout>
    ...
    <section class="mb-4">
        <div class="overflow-x-auto">
            <table class="rounded table table-hover table-striped mb-0 border border-1 shadow-sm table-responsive-md"
                            ...
                            @if (Auth::user()->isAdmin())
                                ...
                                <td class="text-center" style="width: 50px;">
                                    <span data-bs-toggle="modal" data-bs-target="#modal_confirm"
                                        onclick="return JS.modalConfirm('/issue-delete/{{ $issue->id }}')"
