    ...
    <section>
        <form action="/{{ $action }}" id="forms" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <x-input-date id='target_date' name='target_date' :value="old('target_date', Carbon\Carbon::create($issue->target_date)->toDateString() ?? '')" />
            ...
            <div class="mb-3">
                ...
                <x-input-select id='area' name='area' :options='$utility->areas()' :value="old('area', $issue->area ?? '')" :choose="''" />
            ...
            <div class="mb-3">
                ...
                <x-input-textarea id='description' name='description' :placeholder='"Write clearly"'>{{ old('description', $issue->description ?? '') }}</x-input-textarea>
            ...
            <div class="mb-3">
                ...
                <x-input-textarea id='corrective_action' name='corrective_action' :placeholder='"Write clearly"'>{{ old('corrective_action', $issue->corrective_action ?? '') }}</x-input-textarea>
            ...
            <div class="mb-3">
                ...
                <x-input-textarea id='root_cause' name='root_cause' :placeholder='"Write clearly"'>{{ old('root_cause', $issue->root_cause ?? '') }}</x-input-textarea>
            ...
            <div class="mb-3">
                ...
                <x-input-textarea id='preventive_action' name='preventive_action' :placeholder='"Write clearly"'>{{ old('preventive_action', $issue->preventive_action ?? '') }}</x-input-textarea>
