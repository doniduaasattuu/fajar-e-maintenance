                    ...
                    <tr class="table-row">
                                    ...
                                    <td class="text-center text-break {{ $column }}" scope="row">
                                        <a href="/storage/documents/{{ $document->$column }}">
                                            ...
                                            @switch(strtolower(explode('.', $document->$column)[1]))
                                                {{-- PDF --}}
                                                @case('pdf')
                                                    <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22"
                                                        height="22" fill="#dc3545" class="bi bi-file-earmark-pdf-fill"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                ...
                                                @case('ods')
                                                    <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22"
                                                        height="22" fill="#198754" class="bi bi-file-earmark-spreadsheet"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                ...
                                                @case('docx')
                                                    <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22"
                                                        height="22" fill="#0dcaf0" class="bi bi-filetype-docx" viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                ...
                                                @case('doc')
                                                    <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22"
                                                        height="22" fill="#0dcaf0" class="bi bi-filetype-doc" viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                ...
                                                @case('jpg')
                                                    <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22"
                                                        height="22" fill="grey" class="bi bi-file-earmark-image"
                                                        viewBox="0 0 16 16">
                                                ...
                                                @default
                                                    <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22"
                                                        height="22" fill="#198754" class="bi bi-file-earmark-text"
                                                        viewBox="0 0 16 16">
                                                        <path
                        ...
                        @if (Auth::user()->isAdmin())
                            ...
                            @can('update', $document)
                                <td class="text-center" style="width: 50px;">
                                    <a href="/document-edit/{{ $document->id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0d6efd"
                            ...
                            @if (Auth::user()->isSuperAdmin())
                                {{-- DELETE DOCUMENT --}}
                                <td class="text-center" style="width: 50px;">
                                    <span data-bs-toggle="modal" data-bs-target="#modal_confirm"
                                        onclick="return JS.modalConfirm('/document-delete/{{ $document->id }}')"
