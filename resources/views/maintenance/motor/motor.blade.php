<x-app-layout>
    ...
    <script>
        const motor_data = document.getElementById('motor_data');
        ...
        function addMotorRow(motor) {
            ...
            id.textContent = motor.id ?? '';

            let status = document.createElement('td');
            status.textContent = motor.status ?? '';

            let funcloc = document.createElement('td');
            funcloc.textContent = motor.funcloc ?? '';

            let sort_field = document.createElement('td');
            sort_field.textContent = motor.sort_field ?? '';

            let unique_id = document.createElement('td');
            unique_id.textContent = motor.unique_id ?? '';

            let updated_at = document.createElement('td');
            updated_at.textContent = motor.updated_at ?? '';
