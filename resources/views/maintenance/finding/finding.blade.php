            ...
            <div class="col finding">
                <div class="card shadow-md">
                    ...
                    <div class="card-body">
                        ...
                        <div style="color: #9b9fa3; line-height: 22px">
                        ...
                        <div class="row mt-3">
                            <div class="col pe-1">
                                <a href="/finding-edit/{{ $finding->id }}" class="btn btn-outline-primary btn-sm w-100 @cannot('update', $finding) disabled @endcannot">
                            ...
                            <div class="col ps-1">
                                <span class="btn btn-outline-danger btn-sm w-100 @cannot('update', $finding) disabled @endcannot" data-bs-toggle="modal" data-bs-target="#modal_confirm" onclick="return JS.modalConfirm('/finding-delete/{{ $finding->id }}')" style="cursor: pointer">
