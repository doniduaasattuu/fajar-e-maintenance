<x-app-layout>
    ...
    <section class="mb-4 overflow-x-auto">
        {{-- TABLE --}}
        <table class="rounded table table-hover mb-0 border border-1 shadow-sm table-responsive-md" style="min-width: 1000px;">
            <thead>
                <tr>
                    ...
                    @switch($column)
                    @case('department')
                    <th style="line-height: 30px">Dept</th>
                    @break

                    @case('attachment')
                    <th style="line-height: 30px;" class="text-center">Attach</th>
                    @break
                ...
                <tr class="table-row">
                    ...
                    <td class="text-center text-break {{ $column }}" scope="row">
                        <a href="/storage/documents/{{ $document->$column }}">
                            ...
                            {{-- PDF --}}
                            @case('pdf')
                            <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#dc3545" class="bi bi-file-earmark-pdf-fill" viewBox="0 0 16 16">
                            ...
                            @case('xlsx')
                            @case('ods')
                            <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#198754" class="bi bi-file-earmark-spreadsheet" viewBox="0 0 16 16">
                            ...
                            {{-- DOCUMENT WORD --}}
                            @case('docx')
                            <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0dcaf0" class="bi bi-filetype-docx" viewBox="0 0 16 16">
                            ...
                            @break
                            @case('doc')
                            <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0dcaf0" class="bi bi-filetype-doc" viewBox="0 0 16 16">
                            ...
                            @case('jpeg')
                            @case('jpg')
                            <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="grey" class="bi bi-file-earmark-image" viewBox="0 0 16 16">
                            ...
                            @default
                            <svg class="me-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#198754" class="bi bi-file-earmark-text" viewBox="0 0 16 16">
                    ...
                    {{-- DELETE DOCUMENT --}}
                    <td class="text-center" style="width: 50px;">
                        <span data-bs-toggle="modal" data-bs-target="#modal_confirm" onclick="return JS.modalConfirm('/document-delete/{{ $document->id }}')" style="cursor: pointer">
