        ...
        <div class="mb-4">
            ...
            <form action="{{ route('update-profile') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <x-input-text id="nik" name="nik" :value="old('nik', Auth::user()->nik)" :readonly='true' autofocus autocomplete="nik" onkeypress="return JS.onlynumber(event)" maxlength="8" />
                ...
                <div class="mb-3">
                    ...
                    <x-input-text id="fullname" name="fullname" :value="old('fullname', Auth::user()->fullname)" autofocus autocomplete="fullname" />
                ...
                <div class="mb-3">
                    ...
                    <x-input-text id="phone_number" name="phone_number" :value="old('phone_number', Auth::user()->phone_number)" autofocus autocomplete="phone_number" onkeypress="return JS.onlynumber(event)" />
                ...
                <div class="mb-3">
                    ...
                    <x-input-text id="new_password" type="password" name="new_password" autofocus autocomplete="password" />
                ...
                <div class="mb-3">
                    ...
                    <x-input-text id="new_password_confirmation" type="password" name="new_password_confirmation" autofocus autocomplete="password" />
