    ...
    <div class="container">
        ...
        <div class="mt-4 mt-lg-0 collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item me-2 me-md-3">
                    <a id="navbar_logs" class="text-white nav-link" href="/dashboards">
                        <svg class="mb-1 me-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-speedometer2" viewBox="0 0 16 16">
