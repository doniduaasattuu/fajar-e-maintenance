            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown me-2 me-md-3">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="text-dark hover-secondary border-bottom border-top dropdown-item" href="#">Update Equipment</a></li>
                        <li><a class="text-dark border-bottom dropdown-item" href="#">Update Funcloc</a></li>
                        <li><a class="text-dark border-bottom dropdown-item" href="#">Instal Dismantle</a></li>
                    </ul>
                </li>
