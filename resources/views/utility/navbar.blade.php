    ...
    <div class="container-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <form action="/search" method="post" class="my-4 mb-xl-0 my-xl-0 d-flex" role="search">
                @csrf
                <input id="equipment" name="equipment" oninput="return toupper(this)" class="search_input form-control me-2" type="texy" maxlength="9" placeholder="Search by Equipment" aria-label="Search">
