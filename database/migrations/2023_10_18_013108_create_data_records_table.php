...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('data_records', function (Blueprint $table) {
            ...
            $table->enum("vibration_de", ["Good", "Satisfactory", "Unsatisfactory", "Unacceptable"])->nullable(false);
            $table->decimal("vibration_value_nde", 4, 2)->nullable(false);
            $table->enum("vibration_nde", ["Good", "Satisfactory", "Unsatisfactory", "Unacceptable"])->nullable(false);
