...
class EmoRecordSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        for ($i = 0; $i < $year; $i++) {
            ...
            $data_record6->temperature_a = rand(35, 101);
            $data_record6->temperature_b = rand(35, 101);
            $data_record6->temperature_c = rand(35, 101);
            $data_record6->temperature_d = rand(35, 101);
            $data_record6->vibration_value_de = rand(45, 112) / 100;
            $data_record6->vibration_de = "Good";
            $data_record6->vibration_value_nde = rand(45, 112) / 100;
            $data_record6->vibration_nde = "Good";
            ...
            $data_record7->temperature_a = rand(40, 115);
            $data_record7->temperature_b = rand(40, 115);
            $data_record7->temperature_c = rand(40, 115);
            $data_record7->temperature_d = rand(40, 115);
            $data_record7->vibration_value_de = rand(45, 112) / 100;
            $data_record7->vibration_de = "Good";
            $data_record7->vibration_value_nde = rand(45, 112) / 100;
            $data_record7->vibration_nde = "Good";
